...
INSERT INTO Usuarios(id, nombre_completo, anio_nacimiento, sexo, ciudad, pais, email, password, username, token, foto, habilitado, puntaje_acumulado, partidas_realizadas, nivel, preguntas_acertadas, preguntas_entregadas, qr, fecha_registro, latitud, longitud, trampita)
VALUES
    (1, 'ignacio', 1990, 'M', 'CABA', 'Argentina', 'ignacio@gmail.com', '123456', 'ignacio', '123456', 'foto.jpg', TRUE, 0, 0, 'BAJO', 1, 3, 'public/qrs/ignacio.png', '2024-06-18 15:30:00', -34.603722, -58.381592, 100),
    (2, 'Editor', 1990, 'M', 'CABA', 'Argentina', 'editor@gmail.com', '123', 'usurioeditor', '12fdgdf', 'foto.jpg', TRUE, 0, 0, 'BAJO', 1, 3, 'public/qrs/usurioeditor.png', '2024-06-20 15:30:00', -34.603722, -58.381592, 5),
    (3, 'Admin', 1990, 'M', 'CABA', 'Argentina', 'admin@gmail.com', '123', 'usurioadmin', '1234dfgdf56', 'foto.jpg', TRUE, 0, 0, 'MEDIO', 2, 3, 'public/qrs/usurioadmin.png', '2024-06-20 15:30:00', -34.603722, -58.381592, 5),
    (4, 'Mora', 2002, 'F', 'Paris', 'Francia', 'moavalos@gmail.com', '123', 'momo', '1234dfgtdf56', 'foto.jpg', TRUE, 0, 0, 'ALTO', 3, 4, NULL, '2022-06-14 11:20:00', 48.856613, 2.352222, 5),
    (5, 'Maria Garcia', 1995, 'F', 'Madrid', 'España', 'maria@gmail.com', 'password123', 'maria_garcia', 'token1223', 'foto_maria.jpg', TRUE, 400, 5, 'ALTO', 4, 5, NULL, '2024-06-21 10:45:00', 40.416775, -3.703790, 5),
    (6, 'John Smith', 1988, 'M', 'New York', 'Estados Unidos', 'john.smith@gmail.com', 'qwerty456', 'john_smith', 'token456', 'john_photo.jpg', TRUE, 2, 100, 'ALTO', 8, 10, NULL, '2024-06-20 08:15:00', 40.712776, -74.005974, 5),
    (7, 'Sophie Dupont', 1993, 'F', 'Paris', 'Francia', 'sophie.dupont@gmail.com', 'pass123', 'sophie_dupont', 'token7889', 'sophie_pic.jpg', TRUE, 1, 5, 'ALTO', 9, 10, NULL, '2024-06-19 14:20:00', 48.856613, 2.352222, 5),
    (8, 'Anna Müller', 1992, 'F', 'Berlín', 'Alemania', 'anna.mueller@gmail.com', 'abc123', 'anna_mueller', 'token789', 'anna_photo.jpg', TRUE, 3, 20, 'MEDIO', 5, 10, NULL, '2024-06-22 11:00:00', 52.520008, 13.404954, 5),
    (9, 'Luca Rossi', 1985, 'M', 'Roma', 'Italia', 'luca.rossi@gmail.com', 'pass456', 'luca_rossi', 'token1011', 'luca_pic.jpg', TRUE, 1, 5, 'MEDIO', 6, 10, NULL, '2024-06-21 09:30:00', 41.902782, 12.496366, 5),
    (10, 'Chen Wei', 1990, 'M', 'Beijing', 'China', 'chen.wei@gmail.com', 'hello123', 'chen_wei', 'token1213', 'chen_pic.jpg', TRUE, 4, 50, 'MEDIO', 6, 10, NULL, '2024-06-20 13:45:00', 39.904202, 116.407394, 5),
    (11, 'Javier Martínez', 1987, 'M', 'Madrid', 'España', 'javier.martinez@gmail.com', 'clave123', 'javier_martinez', 'token14185', 'javier_foto.jpg', TRUE, 7, 4, 'MEDIO', 6, 10, NULL, '2024-06-19 16:00:00', 40.416775, -3.703790, 5),
    (12, 'Emily Johnson', 1994, 'F', 'London', 'Reino Unido', 'emily.johnson@gmail.com', 'password789', 'emily_johnson', 'token1617', 'emily_pic.jpg', TRUE, 6, 3, 'MEDIO', 5, 10,NULL, '2024-06-18 17:30:00', 51.507351, -0.127758, 5),
    (13, 'Ahmed Hassan', 1980, 'M', 'Cairo', 'Egipto', 'ahmed.hassan@gmail.com', 'egypt123', 'ahmed_hassan', 'toke3n1819', 'ahmed_photo.jpg', TRUE, 3, 2, 'BAJO', 2, 10, NULL, '2024-06-17 12:15:00', 30.044420, 31.235712, 5);
...
(30, '¿Cuál es el animal terrestre más rápido?', 2, 'MEDIO', 4, now(), FALSE, TRUE, 12, 9, TRUE, now()),
(31, '¿Qué planeta es conocido como el Planeta Rojo?', 4, 'FACIL', 4, now(), FALSE, TRUE, 15, 13, TRUE, now()),
(32, '¿En qué año se produjo la Revolución Francesa?', 6, 'DIFICIL', 4, now(), FALSE, TRUE, 10, 4, TRUE, now()),
(33, '¿Quién es el autor de "Romeo y Julieta"?', 8, 'FACIL', 4, now(), FALSE, TRUE, 12, 11, TRUE, now()),
(34, '¿Cuál es el idioma oficial de Brasil?', 7, 'FACIL', 4, now(), FALSE, TRUE, 14, 14, TRUE, now()),
(35, '¿En qué país se encuentra la Gran Muralla?', 7, 'FACIL', 4, now(), FALSE, TRUE, 15, 14, TRUE, now()),
(36, '¿Cuál es el órgano más grande del cuerpo humano?', 5, 'MEDIO', 4, now(), FALSE, TRUE, 13, 10, TRUE, now()),
(37, '¿Quién pintó "La Última Cena"?', 3, 'DIFICIL', 4, now(), FALSE, TRUE, 9, 5, TRUE, now()),
(38, '¿Cuál es el símbolo químico del agua?', 4, 'FACIL', 4, now(), FALSE, TRUE, 18, 16, TRUE, now()),
(39, '¿Qué instrumento mide la presión atmosférica?', 5, 'MEDIO', 4, now(), FALSE, TRUE, 11, 7, TRUE, now()),
(40, '¿Cuál es la capital de Australia?', 7, 'FACIL', 4, now(), FALSE, TRUE, 16, 15, TRUE, now());
...
('Charles Dickens', 33, false),
('Jane Austen', 33, false),
('Mark Twain', 33, false),
('Español', 34, false),
('Portugués', 34, true),
('Francés', 34, false),
...
('Japón', 35, false),
('India', 35, false),
('Corea del Sur', 35, false),
('Corazón', 36, false),
('Hígado', 36, false),
('Piel', 36, true),
('Cerebro', 36, false),
('Leonardo da Vinci', 37, true),
('Michelangelo', 37, false),
('Raphael', 37, false),
('Donatello', 37, false),
('H2O', 38, true),
('O2', 38, false),
