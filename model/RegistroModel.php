...
class RegistroModel
{
    ...
    public function registrarUsuarioAlaBD($nombre, $anio_nacimiento, $sexo,$pais,$ciudad,$email, $password,$username,$foto)
    {
        ...
        $resultado = $this->database->executeAndReturn("INSERT INTO usuarios (nombre_completo, anio_nacimiento, sexo, pais, ciudad, email,password, username, foto,token,habilitado)
