...
class EmailHelper
{
    ...
    public function enviarCorreo($email, $token)
    {
        try {
            ...
            $this->mail->Body = "Hola, gracias por registrarte en nuestro sitio. Haz clic en el siguiente enlace para activar tu cuenta: <a href='http://localhost/registro/validar?token=$token'>Activar cuenta</a>";
